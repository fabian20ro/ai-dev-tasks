...
2. In Copilot's Agent chat, initiate PRD creation:
...
2.  In Copilot's Agent chat, use the PRD to create tasks:
...
2. In Copilot's Agent chat, tell the AI to start with the first task (e.g., `1.1`):
...
1. **Clone or Download:** Get these `.mdc` files into your project or a central location where Copilot can access them.
2. **Follow the Workflow:** Systematically use the `.mdc` files in Copilot's Agent chat as described in the 5-step workflow above.
3. **Adapt and Iterate:**
